...
models_to_test = {
    'Xception'         : lambda: Xception(classes=2),
    'VGG16'            : lambda: VGG16(classes=2),
    'VGG19'            : lambda: VGG19(classes=2),
    ...
    'MobileNetV2'      : lambda: MobileNetV2(classes=2),
    'DenseNet121'      : lambda: DenseNet121(classes=2),
    'DenseNet169'      : lambda: DenseNet169(classes=2),
    'DenseNet201'      : lambda: DenseNet201(classes=2),
    'NASNetMobile'     : lambda: NASNetMobile(classes=2),
    'NASNetLarge'      : lambda: NASNetLarge(classes=2),
    'EfficientNetB0'   : lambda: EfficientNetB0(classes=2),
    'EfficientNetB1'   : lambda: EfficientNetB1(classes=2),
    'EfficientNetB2'   : lambda: EfficientNetB2(classes=2),
    'EfficientNetB3'   : lambda: EfficientNetB3(classes=2),
    'EfficientNetB4'   : lambda: EfficientNetB4(classes=2),
    'EfficientNetB5'   : lambda: EfficientNetB5(classes=2),
    'EfficientNetB6'   : lambda: EfficientNetB6(classes=2),
    'EfficientNetB7'   : lambda: EfficientNetB7(classes=2),
}
